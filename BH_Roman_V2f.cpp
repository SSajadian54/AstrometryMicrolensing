...
///===========================================================
    ...
    FILE* fil1;
    fil1=fopen("./files/MONT/IBH_ROMAN1f.txt","w");
    fclose(fil1);

    FILE* fil2;
    fil2=fopen("./files/MONT/IBH_ROMAN2f.txt","w");
    fclose(fil2);
    
    FILE* fil3;
    fil3=fopen("./files/MONT/IBH_ROMAN3f.txt","w");
    fclose(fil3);
...
///*********************************************************************************   
     ...
     //mh =  magni[3] + RandN( errg*3.0 , 3.0);///error in H-band
  ...
  //  cout<<"dchi:  "<<dchi<<"\t flag_det:  "<<flag_det<<"\t ndw:  "<<ndw<<endl;
    ...
    fil1=fopen("./files/MONT/IBH_ROMAN1f.txt","a+");
    fprintf(fil1,
   "%d  %.5lf   %.5lf  "///3
   "%d  %.5lf   %.5lf   %.5lf  "///7
...
///####################################################################################
  ...
  // cout << endl;}
    ...
    //inverse1(co);
    fil2=fopen("./files/MONT/IBH_ROMAN2f.txt","a+");
...
///HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH   
 ...
 //  cout << endl;}
   ...
   //inverse2(co);
   fil3=fopen("./files/MONT/IBH_ROMAN3f.txt","a+");
